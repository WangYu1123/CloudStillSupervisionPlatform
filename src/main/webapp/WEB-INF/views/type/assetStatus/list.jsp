        ...
        <form class="layui-form" id="form">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <label>
                        <input class="layui-input"  value="{{d.where.assetStatus}}" type="text" placeholder="请输⼊资产状态" name="assetStatus" />
                    </label>
                </div>
            </div>
            <div class="layui-inline">
        ...
        layui.use('table',function(){
            ...
            table.init('table',{
                ...
                cols:[[
                    ...
                    {field:'assetStatusName',title:'资产状态'},
